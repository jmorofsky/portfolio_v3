...
export default function Projects() {
    return (
        <>
            ...
            <div id='content' className='absolute right-px min-[1000px]:top-px top-95 h-188 min-[1000px]:h-[95%] flex flex-col items-end gap-8 mt-6 mx-2 min-[520px]:mx-12'>
                <div>
                    <h1 className='text-right text-xl min-[1200px]:text-3xl font-thin'>Portfolio</h1>
                    <p className='text-right'><a
                        href='https://github.com/jmorofsky/portfolio_v3'
                        target='_blank'
                        className='hover:text-gold max-[520px]:text-xs'
                    ...
                    <div className='mt-4 min-[520px]:w-xs max-[520px]:text-sm flex flex-col gap-2'>
                ...
                <div>
                    <h1 className='text-right text-xl min-[1200px]:text-3xl font-thin'>Blog</h1>
                    <p className='text-right'><a
                ...
                <div>
                    <h1 className='text-right text-xl min-[1200px]:text-3xl font-thin'>Website Monitor</h1>
                    <p className='text-right'><a
                ...
                <div>
                    <h1 className='text-right text-xl min-[1200px]:text-3xl font-thin'>Trump Truth Tracker</h1>
                    <p className='text-right'><a
                ...
                <div>
                    <h1 className='text-right text-xl min-[1200px]:text-3xl font-thin'>Medicare with Meghan Morofsky</h1>
                    <p className='text-right'><a
                    ...
                    <div className='mt-4 min-[520px]:w-xs max-[520px]:text-sm flex flex-col gap-2 min-[520px]:absolute right-px'>
